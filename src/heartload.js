import "./heartload.css"
import "./webfontval2/stylesheet.css"
...
export const HeartL = () => {
 ...
 <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="500" height="200" viewBox="0 0 334 120" enable-background="new 0 0 334 120" xmlSpace="preserve">
...
<path class="linear-4" fill="none" stroke="#F97DC4" stroke-miterlimit="10" d="M40.333,90c0,0,38-29.333,69.333-15.333S176.333,97.333,193,85.333
  ...
  <h1 className="happyval">HAPPY VALENTINE</h1>
  {/* <h3 className="from">From <a href="#">Me</a></h3> */}
</div>
    )
}